...
"""
    ...
    expected = {
        _get_curr_def(): {Import("platform")},
        _get_curr_def("func"): {Import("typing")},
        _get_curr_def("outer_func"): {Import("os"), Import("typing")},
...
def test_collect_module_init(tmp_path: Path) -> None:
    ...
    _test_collect_module("test_module", file_path, root_dir)
